...
class Translator(BaseOpenAIProcessor):
    def __init__(self, client, processor_parameters):
        ...
        self.base_prompt = (
            ...
            "If text cannot be translated as it's a name, number or set of symbols do not comment that. Simply return with the original text. "
            "If text is already in the destination language do not comment that. Simply return with the original text. "
